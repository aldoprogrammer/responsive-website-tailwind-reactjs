...
const Hero = () => (
  ...
  `}>
    ...
    flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2'>
        <img src={discount} alt="discount" 
          ...
          <span className='text-white'>8 Month
          </span> Account
          </p>
      </div>
      ...
      items-center w-full">
        ...
        ss:leading-[100px] leading-[75px]'>The next <br className='sm:block 
        hidden'/> {" "}
        <span className='text-gradient'> React JS</span> {" "} Lesson</h1>
    ...
    md:my-0 my-10 relative}`}>
      ...
      top-30 pink__gradient'/>
      <div className='absolute z-[1] w-[10%] h-[80%]
      bottom-10 white__gradient rounded-full'/>
