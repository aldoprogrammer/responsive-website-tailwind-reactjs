...
const Footer = () => (
    ...
    flex-col`}>
        ...
        ${styles.paddingY} md:flex-row flex-col mb-8 w-full`}>
            {/* <div className={`${styles.flexStart} 
            md:flex-row flex-col 
            md:mr-10 mr-0 mb-8 w-full`}> */}
                <div className='flex-[1] flex flex-col 
                justify-start mr-10'>
                    <img src={logo} 
                    alt="hoobank" className='w-[266px] 
                    h-[72.14px] object-contain'/>
                        ...
                        ss:my-0 my-4 min-w-[150px]'>
                            ...
                            <ul className='list-none mt-4'>
                                {footerlink.links.map((link, index) => (
                                    ...
                                    font-normal text-base leading-[24px] text-dimWhite
